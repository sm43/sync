...
import (
	...
	externalversions "github.com/sm43/sync/pkg/client/informers/externalversions"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/sm43/sync/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
